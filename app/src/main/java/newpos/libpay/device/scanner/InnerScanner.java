...
public class InnerScanner {
    ...
    private newpos.libpay.device.scanner.InnerScannerListener mOnScannedListener ;
    ...
    public InnerScanner(AppCompatActivity activity){
...
//                        setBackView();
     ...
     */
    public void startScan(int timeout, newpos.libpay.device.scanner.InnerScannerListener listener) {
        if(listener==null){
